...
class ProgressRingView: UIView {
    ...
    func configure(with gradable: GradableRepresentable) {
        ...
        let circularPath = UIBezierPath(arcCenter: circleCenter,
                                        radius: circleRadius,
                                        startAngle: circleStartAngle,
                                        endAngle: circleStartAngle + constantAngle * CGFloat(gradable.grade / gradable.maxGrade),
                                        clockwise: true)
        frontShapeLayer.path = circularPath.cgPath
        frontShapeLayer.fillColor = UIColor.clear.cgColor
        frontShapeLayer.strokeColor = gradable.statusColor.cgColor
